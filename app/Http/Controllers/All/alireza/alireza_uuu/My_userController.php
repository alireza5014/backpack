...
namespace App\Http\Controllers\All\alireza\alireza_uuu;

use App\Model\All\alireza\alireza_uuu\My_user;
   ...
   public $username;
    ...
    public function create(Request $request)
    {
        ...
        try {
            $data = My_user::create(
                [
                    "id"=> $request->id,"fname"=> $request->fname,"lname"=> $request->lname
                ]
            );
        } catch (Exception $exception) {
            $code = 400;
